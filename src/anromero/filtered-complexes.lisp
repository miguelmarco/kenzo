...
(DEFMETHOD CHANGE-CHCM-TO-FLCC ((chcm chain-complex) flin)
  (declare
...
(DEFMETHOD CHANGE-CHCM-TO-FLCC ((chcm coalgebra) flin)
  (declare      
   (type chcm-flin flin))
  (the FILTERED-COALGEBRA
    (progn
...
(DEFMETHOD CHANGE-CHCM-TO-FLCC ((chcm algebra) flin)
  (declare      
   (type chcm-flin flin))
  (the FILTERED-ALGEBRA
    (progn
...
(DEFMETHOD CHANGE-CHCM-TO-FLCC ((chcm hopf-algebra) flin)
  (declare      
   (type chcm-flin flin))
  (the FILTERED-hopf-algebra
    (progn
...
(DEFMETHOD CHANGE-CHCM-TO-FLCC ((chcm simplicial-set) flin)
  (declare      
   (type chcm-flin flin))
  (the FILTERED-SIMPLICIAL-SET
    (progn
...
(DEFMETHOD CHANGE-CHCM-TO-FLCC ((chcm kan) flin)
  (declare      
   (type chcm-flin flin))
  (the FILTERED-KAN
    (progn
...
(defmethod CHANGE-CHCM-TO-FLCC ((chcm simplicial-group) flin)
  (declare   
   (type chcm-flin flin))
  (the FILTERED-SIMPLICIAL-GROUP
    (progn
...
(DEFMETHOD CHANGE-CHCM-TO-FLCC ((chcm ab-simplicial-group) flin)
  (declare
     (type chcm-flin flin))
...
(change-chcm-to-flcc bar2 abar-flin)
