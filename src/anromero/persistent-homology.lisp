;; PERSISTENT-HOMOLOGY PERSISTENT-HOMOLOGY PERSISTENT-HOMOLOGY PERSISTENT-HOMOLOGY 
;; PERSISTENT-HOMOLOGY PERSISTENT-HOMOLOGY PERSISTENT-HOMOLOGY PERSISTENT-HOMOLOGY 
;; PERSISTENT-HOMOLOGY PERSISTENT-HOMOLOGY PERSISTENT-HOMOLOGY PERSISTENT-HOMOLOGY 

(IN-PACKAGE #:cat)

(provide "persistent-homology")
       ...
       (declare 
        ...
        (type gnrt gnrt))
          (let (
                ...
                (l7 (list 'abc))
                (rslt -1))
            (declare (list l1 l2 l3 l4 l5 l6 l7)
                     (type fixnum rslt))
              (if (contains l1 gnrt)  (setf rslt 1)
                (if (contains l2 gnrt)  (setf rslt 2)
                  (if (contains l3 gnrt)  (setf rslt 3)
                    (if (contains l4 gnrt)  (setf rslt 4)
                      (if (contains l5 gnrt)  (setf rslt 5)
                        (if (contains l6 gnrt)  (setf rslt 6)
                           (if (contains l7 gnrt)  (setf rslt 7)
...
(dotimes (n 3)
  (dotimes (p 8)
    (print (total-prst-hmlg-group triangle p p n))
    (print (total-prst-hmlg-group triangle p (1+ p) n))
    (print (total-prst-hmlg-group triangle p (+ 2 p) n))
    (print (total-prst-hmlg-group triangle p (+ 3 p) n))
    (print (total-prst-hmlg-group triangle p (+ 4 p) n))
    ))


(print (prst-hmlg-group triangle 1 8 0))
